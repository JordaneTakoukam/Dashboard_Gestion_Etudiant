...
import { formatDate, formatYear } from '../../../fonctions/fonction';
...
function ModalCreateUpdate({ periodeEnseignement }: { periodeEnseignement: PeriodeEnseignementType | null }) {
    ...
    useEffect(() => {
        ...
        if (periodeEnseignement) {
            ...
            setDateDebut(periodeEnseignement.dateDebut ? formatDate(periodeEnseignement.dateDebut) : "");
            setDateFin(periodeEnseignement.dateFin ? formatDate(periodeEnseignement.dateFin) : "");
