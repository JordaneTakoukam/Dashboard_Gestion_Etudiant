...
function ModalCreateUpdate({ section }: { section : Section | null }) {
    ...
    useEffect(() => {
        if (section) {
            setModalTitle("Mettre à jour les informations de la section");
            setCode(section.code);
            setLibelle(section.libelle);
            
        } else {
            setModalTitle("Enregistrer une nouvelle section");
            setCode("");
            setLibelle("");
        }
