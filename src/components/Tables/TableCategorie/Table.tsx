...
const Table = ({ data, onCreate, onEdit }: TableCategorieProps) => {
    ...
    // };
    // const handleCategorieSelect = (selected: string) => {
    //     setFiltreCategorie(selected);
    //     console.log(selected);
    // };
                ...
                <div className="block lg:hidden">
                    ...
                    {isDropdownVisible && (
                        <div className="flex flex-col justify-start items-start overflow-y-scroll pb-2 h-[200px] gap-x-2 ">
                            ...
                            <CustomDropDown title="Categorie" items={['Douane', 'Impôt']} defaultValue="Douane" onSelect={handleCategorieSelect} />
