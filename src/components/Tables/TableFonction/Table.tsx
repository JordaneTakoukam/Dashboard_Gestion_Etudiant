...
const Table = ({ data, onCreate, onEdit }: TableFonctionProps) => {
    ...
    // };
    // const handleFonctionSelect = (selected: string) => {
    //     setFiltreFonction(selected);
    //     console.log(selected);
    // };
                ...
                <div className="block lg:hidden">
                    ...
                    {isDropdownVisible && (
                        <div className="flex flex-col justify-start items-start overflow-y-scroll pb-2 h-[200px] gap-x-2 ">
                            ...
                            <CustomDropDown title="Fonction" items={['Douane', 'Impôt']} defaultValue="Douane" onSelect={handleFonctionSelect} />
