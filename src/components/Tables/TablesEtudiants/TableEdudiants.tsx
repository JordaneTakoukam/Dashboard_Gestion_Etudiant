                ...
                <div className="block lg:hidden">
                    ...
                    {isDropdownVisible && (
                        <div className="flex flex-col justify-start items-start overflow-y-scroll pb-2 h-[200px] gap-x-2 ">
                            <CustomDropDown title="Année" items={['2024', '2023', '2022']} defaultValue="2024" onSelect={handleAnneeSelect} />
                            <CustomDropDown title="Section" items={['Francophone', 'Anglophone']} defaultValue="Francophone" onSelect={handleSectionSelect} />
                            <CustomDropDown title="Cycle" items={['License', 'Master', 'Doctorat']} defaultValue="License" onSelect={handleCycleSelect} />
                            <CustomDropDown title="Niveau" items={['1', '2', '3', '4', '5']} defaultValue="1" onSelect={handleNiveauSelect} />
                        </div>
                    )}
                </div>
